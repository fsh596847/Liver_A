...
public abstract class AppAsyncTask <Params, Progress, Result>{
     ...
     */
    public final AppAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     */
    public final AppAsyncTask<Params, Progress, Result> executeOnExecutor(
    ...
    private static class KJTaskResult<Data> {
        final Data[] mData;
        final AppAsyncTask<?, ?, ?> mTask;

        KJTaskResult(AppAsyncTask<?, ?, ?> task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
