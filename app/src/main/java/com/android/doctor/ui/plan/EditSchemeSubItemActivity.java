 ...
 */
public class EditSchemeSubItemActivity extends BaseActivity implements View.OnClickListener {
    public static final String TAG = LogUtil.getLogUtilsTag(EditSchemeSubItemActivity.class);
