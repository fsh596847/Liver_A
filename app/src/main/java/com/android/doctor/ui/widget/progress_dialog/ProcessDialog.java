...
package com.android.doctor.ui.widget.progress_dialog;
...
public class ProcessDialog {
  ...
  /**
   * Create a new HUD. specify the HUD style (if you use a custom view, you need {@code KProgressHUDt.create(Context context)}).
   *
   * @param context Activity context that the HUD bound to
   * @param style One of the KProgressHUDt.Style values
   * @return An unique HUD instance
   */
    public static ProcessDialog create(Context context, Style style) {
        return new ProcessDialog(context).setStyle(style);
    }
     ...
     * @return Current HUD
     */
    public ProcessDialog setStyle(Style style) {
        View view = null;
        switch (style) {
     ...
     * @return Current HUD
     */
    public ProcessDialog setDimAmount(float dimAmount) {
     ...
     * @return Current HUD
     */
    public ProcessDialog setSize(int width, int height) {
     ...
     * @return Current HUD
     */
    public ProcessDialog setWindowColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public ProcessDialog setCornerRadius(float radius) {
     ...
     * @return Current HUD
     */
    public ProcessDialog setAnimationSpeed(int scale) {
        mAnimateSpeed = scale;
        return this;
    }
     ...
     * @return Current HUD
     */
    public ProcessDialog setLabel(String label) {
     ...
     * @return Current HUD
     */
    public ProcessDialog setDetailsLabel(String detailsLabel) {
     ...
     * @return Current HUD
     */
    public ProcessDialog setMaxProgress(int maxProgress) {
     ...
     * @return Current HUD
     */
    public ProcessDialog setCustomView(View view) {
        if (view != null) {
            mProgressDialog.setView(view);
        } else {
     ...
     * @return Current HUD
     */
    public ProcessDialog setCancellable(boolean isCancellable) {
     ...
     * @return Current HUD
     */
    public ProcessDialog setAutoDismiss(boolean isAutoDismiss) {
