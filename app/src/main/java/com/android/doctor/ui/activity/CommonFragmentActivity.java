...
import com.android.doctor.ui.fragment.FragmentClinicPatient;
...
public class CommonFragmentActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        if (FRAGMENT_TYPE_COMMENT_LIST.equals(mType)) {
            FragmentClinicPatient f = new FragmentClinicPatient();
            trans.replace(R.id.fl_container, f);
            //setActionBar(R.string.charity_show);
        } else if (FRAGMENT_TYPE_STAT_CHART.equals(mType)) {
