 ...
 */
public class EditSchemeItemActivity extends BaseActivity implements View.OnClickListener {
    public static final String TAG = LogUtil.getLogUtilsTag(EditSchemeItemActivity.class);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.tv_delete){
            LogUtil.d(LogUtil.getLogUtilsTag(EditSchemeItemActivity.class), " delete index : " + index);
            if (index != -1) {
    ...
    private void onSubItem(View v) {
        ...
        if (0 <= index && index < mDataItems.getItems().size()) {
            ...
            if (mReqCode == PlanSchemeActivity.REQUEST_DOCTOR_MEDICINE_CODE) {
                intent.setClass(this, EditMedicineItemActivity.class);
            } else {
                intent.setClass(this, EditSchemeSubItemActivity.class);
            }
    ...
    protected void onComplete() {
        ...
        LogUtil.d(LogUtil.getLogUtilsTag(EditSchemeItemActivity.class), "" + bCheck);
