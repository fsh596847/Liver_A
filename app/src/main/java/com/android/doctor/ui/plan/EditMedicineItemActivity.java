 ...
 */
public class EditMedicineItemActivity extends BaseActivity{
    ...
    protected void onSelectUsage() {
        Intent intent = new Intent();
        intent.setClass(this, SelectListItemActivity.class);
        startActivityForResult(intent, REQUEST_CODE_SELECT_USAGE);
    }
    ...
    protected void onSelectUseLevel() {
        Intent intent = new Intent();
        intent.setClass(this, SelectListItemActivity.class);
        startActivityForResult(intent, REQUEST_CODE_SELECT_USELEVEL);
    }
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                case REQUEST_CODE_SELECT_MEDICINE:
                    mEdtMeName.setText(txt);
                    break;
                case REQUEST_CODE_SELECT_USAGE:
                    mTvUsage.setText(txt);
                    break;
                case REQUEST_CODE_SELECT_USELEVEL:
                    mTvUseLevel.setText(txt);
                    break;
            }
        }
    }
