...
import com.fidots.restaurant.ui.adapter.MerchantSpecificProductAdapter;
 ...
 */
public class FragmentMerchantSpecificProduct extends BaseRecyViewFragment {
    ...
    protected void setAdapter() {
        adapter = new MerchantSpecificProductAdapter();
