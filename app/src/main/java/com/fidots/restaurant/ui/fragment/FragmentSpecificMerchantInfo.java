...
import com.fidots.restaurant.ui.adapter.SpecificMerchantInfoAdapter;
 ...
 */
public class FragmentSpecificMerchantInfo extends BaseRecyViewFragment {
    ...
    protected void setAdapter() {
        adapter = new SpecificMerchantInfoAdapter();
