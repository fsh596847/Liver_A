...
public class VolleyErrorHelper {
    ...
    public static int getErrorResID(Object error, Context context) {
        if (error instanceof TimeoutError) {
            return R.string.generic_server_timeout;
        } else if (error instanceof AuthFailureError) {
            ...
            return R.string.parsing_failed;
        }
	...
	public static boolean isServerProblem(Object error) {
		return (error instanceof ServerError) || (error instanceof TimeoutError) || (error instanceof ParseError);
	}

	public static boolean isAuthFailure(Object error) {
		return (error instanceof AuthFailureError);
	}
	
	public static int getStatusCode(Object error) {
