...
public class ConversationSqlManager extends AbstractSQLManager {
    ...
    public static Cursor getConversationCursor() {
        try {
            ...
            String sql = "SELECT unreadCount, im_thread.type, sendStatus, dateTime, sessionId, text, username ,name , userData,im_thread.contactid ,isnotice\n" +
                    "      FROM im_thread \n" +
    ...
    public static long insertSessionRecord(ECMessage msg) {
        ...
        try {
            ...
            values.put(IThreadColumn.USER_DATA, msg.getUserData());
